    ...
    <Sidebar>
      <SidebarHeader className="border-b border-sidebar-border/50 pb-4 mb-2 bg-gradient-to-r from-sidebar-background to-sidebar-accent/30">
        <div className="flex flex-col px-4 py-2 gap-1">
          ...
          <div className="flex flex-col pl-[3.25rem] gap-1">
      ...
      <SidebarFooter className="border-t border-sidebar-border/50 p-2">
        <SidebarMenu>
          <SidebarMenuItem>
            <div className="flex items-center gap-3 px-3 py-2 text-sm rounded-md bg-sidebar-accent/50 text-sidebar-foreground border border-sidebar-border/50 shadow-sm">
              <div className="bg-primary/10 p-1 rounded-full text-primary">
                <UserCircle className="size-5" />
              </div>
              <span className="truncate font-medium">{userEmail || "Usuario"}</span>
            </div>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton 
